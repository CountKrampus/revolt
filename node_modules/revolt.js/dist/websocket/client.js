            ...
            const process = (packet) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    switch (packet.type) {
                        ...
                        case "ChannelDelete": {
                            const channel = this.client.channels.get(packet.id);
                            channel === null || channel === void 0 ? void 0 : channel.delete(true);
                        ...
                        case "ServerDelete": {
                            const server = this.client.servers.get(packet.id);
                            server === null || server === void 0 ? void 0 : server.delete(true);
                            ...
                            if (packet.user === this.client.user._id) {
                                ...
                                (0, mobx_1.runInAction)(() => {
                                    ...
                                    (_a = this.client.servers
                                        .get(server_id)) === null || _a === void 0 ? void 0 : _a.delete(true);
