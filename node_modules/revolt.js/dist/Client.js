...
const Unreads_1 = __importDefault(require("./util/Unreads"));
/**
...
class Client extends eventemitter3_1.default {
    constructor(options = {}) {
        ...
        this.options = (0, lodash_defaultsdeep_1.default)(options, config_1.defaultConfig);
        if (this.options.cache)
            throw "Cache is not supported yet.";
        if (this.options.unreads) {
            this.unreads = new Unreads_1.default(this);
        }
        this.api = new revolt_api_1.API({ baseURL: this.apiURL });
    ...
    markdownToText(source) {
        return source
            .replace(exports.RE_MENTIONS, (sub, id) => {
