...
class Channel {
    constructor(client, data) {
        ...
        switch (data.channel_type) {
            case "DirectMessage": {
                this.active = (0, null_1.toNullable)(data.active);
                this.recipient_ids = (0, null_1.toNullable)(data.recipients);
                this.last_message_id = (0, null_1.toNullable)(data.last_message_id);
                break;
            }
            case "Group": {
                this.recipient_ids = (0, null_1.toNullable)(data.recipients);
                this.name = (0, null_1.toNullable)(data.name);
                this.owner_id = (0, null_1.toNullable)(data.owner);
                this.description = (0, null_1.toNullable)(data.description);
                this.last_message_id = (0, null_1.toNullable)(data.last_message_id);
                this.icon = (0, null_1.toNullable)(data.icon);
                this.permissions = (0, null_1.toNullable)(data.permissions);
                this.nsfw = (0, null_1.toNullable)(data.nsfw);
                break;
            }
            case "TextChannel":
            case "VoiceChannel": {
                this.server_id = (0, null_1.toNullable)(data.server);
                this.name = (0, null_1.toNullable)(data.name);
                this.description = (0, null_1.toNullable)(data.description);
                this.icon = (0, null_1.toNullable)(data.icon);
                this.default_permissions = (0, null_1.toNullable)(data.default_permissions);
                this.role_permissions = (0, null_1.toNullable)(data.role_permissions);
    ...
    updateGroupLeave(user) {
        var _a;
        this.recipient_ids = (0, null_1.toNullable)((_a = this.recipient_ids) === null || _a === void 0 ? void 0 : _a.filter((x) => x !== user));
    }
    ...
    sendMessage(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = Object.assign({ nonce: (0, ulid_1.ulid)() }, (typeof data === "string" ? { content: data } : data));
    ...
    fetchMessages(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, mobx_1.runInAction)(() => messages.map(this.client.messages.createObj));
        });
    }
    /**
    ...
    ack(message, skipRateLimiter) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            const id = (_b = (_a = (typeof message === "string" ? message : message === null || message === void 0 ? void 0 : message._id)) !== null && _a !== void 0 ? _a : this.last_message_id) !== null && _b !== void 0 ? _b : (0, ulid_1.ulid)();
            const performAck = () => {
     ...
     */
    get permission() {
        return (0, calculator_1.calculatePermission)(this);
    }
    /**
