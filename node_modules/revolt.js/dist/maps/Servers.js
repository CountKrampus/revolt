...
class Server {
    constructor(client, data) {
        ...
        this.categories = (0, null_1.toNullable)(data.categories);
        this.system_messages = (0, null_1.toNullable)(data.system_messages);
        this.roles = (0, null_1.toNullable)(data.roles);
        this.default_permissions = data.default_permissions;
        this.icon = (0, null_1.toNullable)(data.icon);
        this.banner = (0, null_1.toNullable)(data.banner);
        this.nsfw = (0, null_1.toNullable)(data.nsfw);
        this.flags = (0, null_1.toNullable)(data.flags);
...
class Servers extends Collection_1.default {
    ...
    fetch(id, data, channels) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, mobx_1.runInAction)(() => __awaiter(this, void 0, void 0, function* () {
                if (channels) {
