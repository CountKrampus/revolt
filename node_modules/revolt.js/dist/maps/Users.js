...
class User {
    constructor(client, data) {
        ...
        this.avatar = (0, null_1.toNullable)(data.avatar);
        this.badges = (0, null_1.toNullable)(data.badges);
        this.status = (0, null_1.toNullable)(data.status);
        this.relationship = (0, null_1.toNullable)(data.relationship);
        ...
        this.bot = (0, null_1.toNullable)(data.bot);
    ...
    update(data, clear = []) {
        const apply = (key) => {
            ...
            typeof data[key] !== "undefined" &&
                // @ts-expect-error TODO: clean up types here
                !(0, lodash_isequal_1.default)(this[key], data[key])) {
                // @ts-expect-error TODO: clean up types here
                this[key] = data[key];
                if (key === "relationship") {
